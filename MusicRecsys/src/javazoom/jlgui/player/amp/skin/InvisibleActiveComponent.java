...
/**
 * InvisibleActiveComponent is used to manage two state graphical components with optional
 * checkbox property.
 */
public class InvisibleActiveComponent extends Component implements SkinComponent
{ 
	 ...
	 */
	public InvisibleActiveComponent(Image releasedImage, Image pressedImage, long theMask, boolean checkbox, boolean checkboxinitstate)
	{
	 ...
	 */
	public InvisibleActiveComponent(Image releasedImage, Image pressedImage, long theMask)
	{
