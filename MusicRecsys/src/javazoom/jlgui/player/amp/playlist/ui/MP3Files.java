...
*/
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    else if (cmd.equals("Add File"))
    {
      ...
      String strangeFile = FileSelector.getDirectory();
      System.out.println ("Added file" + fsFile);
      System.out.println ("But file is "+ strangeFile);
      fsFile = parseFileName(strangeFile);
      if (fsFile != null)
      {
        ...
        {
          PlaylistItem pli = new PlaylistItem(fsFile, strangeFile, -1, true);
    ...
    else if (cmd.equals("Add Dir"))
    {
      ...
      System.out.println ("Add directory: "+fsFile);
